...
type AccountPayload = PaginationData & {
  data: Account[];
}

type Props = {
  accounts_payload: AccountPayload;
};

export default function AccountsPage({ accounts_payload }: Props) {
  const accounts = accounts_payload.data;
  ...
  return (
    <ManageLayout>
      <div className="max-w-3xl mx-auto p-6 space-y-4">
        ...
        <Pagination payload={accounts_payload} back_route_name={null} only={["accounts_payload"]}/>
        {open && (
