      ...
      <div className="relative max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="rounded-lg shadow-xl shadow-blue-500/30 overflow-hidden w-10 h-10">
                {/* KONVERSI: Next/Image diganti img tag biasa */}
                <img
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              {["Home", "Gallery", "Contact"].map((link) => (
                <li key={link}>
                  {/* KONVERSI: Menggunakan Link Inertia untuk navigasi antar halaman */}
                  {/* Logika: Jika link "Home", href="/". Jika lain, href="/nama-halaman" */}
                  <Link
                    href={link === "Home" ? "/" : `/${link.toLowerCase()}`}
                    className="text-blue-200 hover:text-white hover:translate-x-2 transition-all duration-300 flex items-center gap-2 group w-full text-left"
                  >
                    <span className="w-1 h-1 bg-blue-400 rounded-full group-hover:w-2 group-hover:h-2 transition-all duration-300 shadow-lg shadow-blue-500/50"></span>
                    {link}
                  </Link>
